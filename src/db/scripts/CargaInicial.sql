...
-- Senhas em texto plano apenas para seed local; a API faz upgrade automático para bcrypt no boot.
INSERT IGNORE INTO Psicologo (Nome, CPF, CRP, Email, Senha)
VALUES 
('Dr. João Silva', '12345678901', 'CRP-12345', 'joao.silva@exemplo.com', '123456');

INSERT IGNORE INTO Paciente (Nome, Data_Nascimento, CPF, Email, NomeDoResponsavel, Telefone, fk_idProfissional, Senha)
VALUES 
...
INSERT IGNORE INTO Atividade_Paciente (Descricao, NivelDificuldade, ObservacaoAtividade, DH_Fim, fk_idPaciente)
VALUES 
...
INSERT IGNORE INTO Anotacao_Paciente (Descricao, EmocaoEstimada, DH_Registro, fk_idPaciente, Titulo)
VALUES 
