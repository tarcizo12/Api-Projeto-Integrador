-- Inserir Psicólogo
INSERT INTO public."Psicologo" ("Nome", "CPF", "CRP", "Email", "Senha")
VALUES
('Dr. João Silva', '12345678901', 'CRP-12345', 'joao.silva@exemplo.com', '123456');

-- Inserir Pacientes
INSERT INTO public."Paciente" ("Nome", "Data_Nascimento", "CPF", "Email", "NomeDoResponsavel", "Telefone", "fk_idProfissional", "Senha")
VALUES
...
INSERT INTO public."Atividade_Paciente" ("Descricao", "NivelDificuldade", "ObservacaoAtividade", "DH_Fim", "fk_idPaciente")
VALUES
...
INSERT INTO public."Anotacao_Paciente" ("Descricao", "EmocaoEstimada", "DH_Registro", "fk_idPaciente", "Titulo")
VALUES
